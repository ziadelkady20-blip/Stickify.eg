...
const DEFAULT_FEATURES: Feature[] = [
  { id: "f1", icon: "🚚", titleEn: "Fast Delivery", titleAr: "توصيل سريع", descEn: "2-5 days Cairo/Giza, up to 7 days nationwide.", descAr: "٢-٥ أيام القاهرة والجيزة، لغاية ٧ أيام للمحافظات.", order: 1 },
